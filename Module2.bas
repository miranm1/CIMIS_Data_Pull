...
Sub ReadCIMISET()
 ' initialize req'd variables and sheet
    ...
    origSelectedCell = ActiveCell.Address   'save original cell you started from
    ActiveSheet.Range("A6").Select          ' start at cell A6
    wscount = WorksheetFunction.CountA(Range("6:6")) / 2
    Application.ScreenUpdating = False
    wscounter = 1
    While ActiveCell.Value <> ""
    
        'created a statusbar to display progress
        ...
        webServiceURL = "http://et.water.ca.gov/api/data?appKey=ab1b4d2a-086c-4bb7-aa66-8573e194a589&targets=" & _
            ...
            Format(Range("B3").Value, "yyyy-mm-dd") & "&dataItems=day-eto"
    ...
    On Error GoTo ErrCatcher
        ...
        For Each Provider In JSON("Data")("Providers")
            ...
            Values(i, 1) = Record("DayEto")("Value")
            i = i + 1
            Next Record
        Next Provider
        
        
        ' Writes data on the spread sheet
        a = UBound(Values)
